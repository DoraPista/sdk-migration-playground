...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddSingleton<IAppNavigation, ShellNavigation>();
        builder.Services.AddSingleton<LegacyNavigationService>();

        // Pages and their view models are transient: each navigation gets a fresh one, so no stale data.
        builder.Services.AddTransient<MigrationListPage>();
        builder.Services.AddTransient<MigrationListViewModel>();
        builder.Services.AddTransient<MigrationDetailPage>();
        builder.Services.AddTransient<MigrationDetailViewModel>();
